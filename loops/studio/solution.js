...
let veggies = ["peas", "green beans", "kale", "edameme", "broccoli", "asparagus"];
...
function mealAssembly(protein, grains, veggies, beverages, desserts, numMeals) {
  ...
  //loop through number of meals//
  for (let index = 0; index < numMeals; index++) {
    let meal = [];
    //loop through length of pantry//
...
while (numMeals < 1 || numMeals > 6) {
    numMeals = input.question("invalid input: please enter meals 1-6")
